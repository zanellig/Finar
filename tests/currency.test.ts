...
function createTestDb() {
  ...
  raw.run(`CREATE TABLE credit_cards (
    id TEXT PRIMARY KEY,
    entity_id TEXT NOT NULL,
    name TEXT NOT NULL,
  ...
  raw.run(`CREATE TABLE cc_spenditures (
    id TEXT PRIMARY KEY,
  ...
  raw.run(`CREATE TABLE exchange_rates (
    id TEXT PRIMARY KEY,
    pair TEXT NOT NULL,
